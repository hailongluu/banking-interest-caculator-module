...
public class AccountDAOTest {
    ...
    public void invalidLoginMissingPassword() {
        String username = "account1@bank.com";
        String password = PasswordHash.md5Hash("");
        boolean expectedResult = false;
        boolean result = accountDAO.authenticateAccount(username, password);
        Assert.assertEquals(expectedResult, result);
    }
    ...
    @Test
    public void invalidLoginSQLInjection() {
        String username = "1' or1=1;--";
        String password = PasswordHash.md5Hash("1234");
        boolean expectedResult = false;
        boolean result = accountDAO.authenticateAccount(username, password);
        Assert.assertEquals(expectedResult, result);
    ...
    public void invalidLoginWrongUsername() {
        String username = "acount1@bank.com";
        String password = PasswordHash.md5Hash("1234");
        boolean expectedResult = false;
        boolean result = accountDAO.authenticateAccount(username, password);
        Assert.assertEquals(expectedResult, result);
    ...
    public void invalidLoginWrongPassword() {
        String username = "account1@bank.com";
        String password = PasswordHash.md5Hash("123");
        boolean expectedResult = false;
        boolean result = accountDAO.authenticateAccount(username, password);
        Assert.assertEquals(expectedResult, result);
    }
